    ...
    <div style="width: 400px; margin: 100px auto">
      ...
      <el-form ref="form" :model="form" size="normal" :rules="rules">
        <el-form-item prop="name">
          <el-input class="input_box" prefix-icon="el-icon-user" maxlength="12" v-model="form.name" placeholder="请输入用户名"></el-input>
        </el-form-item>
        <el-form-item prop="password">
          <el-input class="input_box" prefix-icon="el-icon-lock" maxlength="12" minlength="12" v-model="form.password" show-password placeholder="请输入密码"></el-input>
        </el-form-item>
        <el-form-item>
